...
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1" # 使用第三、四块GPU 第一块PU
import numpy as np
...
#config.gpu_options.per_process_gpu_memory_fraction = 0.8 #显存最多占用比例
#config.gpu_options.allow_growth = True  # 自适应占用显存
...
#miccai数据
#train_dir = "./miccai_train_128/train/"
#train_mask_dir = "./miccai_train_128/train_mask/"
#validation_while_training = "./miccai_train_128/val_while_train/"
#validation_mask_while_training = "./miccai_train_128/val_mask_while_train/"

#2017ACDC数据
#train_dir = "./ACDC_train_128/train/"
#train_mask_dir = "./ACDC_train_128/train_mask/"
#validation_while_training = "./ACDC_train_128/val_while_train/"
#validation_mask_while_training = "./ACDC_train_128/val_mask_while_train/"

#2017ACDC+miccai数据
#train_dir = "./all_train_128/train/"
#train_mask_dir = "./all_train_128/train_mask/"
#validation_while_training = "./all_train_128/val_while_train/"
#validation_mask_while_training = "./all_train_128/val_mask_while_train/"

#rv_datasets miccai2012
#train_dir = "./train/train/"
#train_mask_dir = "./train/train_mask/"
#validation_while_training = "./train/val_while_train/"
#validation_mask_while_training = "./train/val_mask_while_train/"

#rv_datasets(ACDC2017)
#train_dir = "./trainACDC2017/train/"
#train_mask_dir = "./trainACDC2017/train_mask/"
#validation_while_training = "./trainACDC2017/val_while_train/"
#validation_mask_while_training = "./trainACDC2017/val_mask_while_train/"

#cornary_datasets(myself)
#train_dir = "./datasets2/one-label(png)DL/train/"
#train_mask_dir = "./datasets2/one-label(png)DL/train_mask/"
#validation_while_training = "./datasets2/one-label(png)DL/val_while_train/"
#validation_mask_while_training = "./datasets2/one-label(png)DL/val_mask_while_train/"

#cornary_datasets(myself)
#train_dir = "./datasets9/train/"
#train_mask_dir = "./datasets9/train_mask/"
#validation_while_training = "./datasets9/val_while_train/"
#validation_mask_while_training = "./datasets9/val_mask_while_train/"
...
#train_dir = "./datasets4(right-ventricle)/train/"
#train_mask_dir = "./datasets4(right-ventricle)/train_mask/"
#validation_while_training = "./datasets4(right-ventricle)/val_while_train/"
#validation_mask_while_training = "./datasets4(right-ventricle)/val_mask_while_train/"

#完整的miccai数据
#train_dir = "./my_miccai_train/train/"
#train_mask_dir = "./my_miccai_train/train_mask/"
#validation_while_training = "./my_miccai_train/val_while_train/"
#validation_mask_while_training = "./my_miccai_train/val_mask_while_train/"
...
def load_data():
    ...
    train_list = os.listdir(train_dir)#所有训练图像文件名列表
    val_while_train_list = os.listdir(validation_while_training)#所有验证图像文件名列表
...
def training(FLAGS, n_channels):
    ...
    train_data_gen_mask_args = dict(train_data_gen_args.items())#数据增强的参数
    ...
    train_generator_flow = my_generator(train_generator, train_mask_generator)#训练图像和金标准
    
    
    validation_generator_flow = my_generator(validation_generator, validation_mask_generator)#验证图像和金标准
